...
function Home() {
    return (
        <>
            ...
            <Header /> 
            <section id="inicio" className="lg:pt-24"> 
            {/* Contenido */} 
            <MainImg />
            </section> 
            <SectionImg 
                title="CONOCE EL BARRE"
                body="El Barre es un método de entrenamiento que combina elementos del ballet, pilates y yoga para fortalecer y tonificar el cuerpo. 
                        Se centra en movimientos precisos y controlados, utilizando la barra como soporte para mejorar la postura, la flexibilidad y la fuerza muscular. "
                image="/src/assets/barre-2.jpg"
                className="bg-[#462036]"/> 
                <SectionImgLft
                title="PRIMER ESTUDIO EN VALPARAÍSO"
                body="El primer estudio de Barre en Valparaíso, ofreciendo clases de alta calidad para todos los niveles. 
                Nuestro enfoque se centra en la técnica, la seguridad y el bienestar de nuestros estudiantes, brindando un ambiente acogedor y motivador para alcanzar sus objetivos de fitness y salud."
