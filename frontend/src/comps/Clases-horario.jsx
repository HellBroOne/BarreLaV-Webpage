...
function ClasesHorario() {
    ...
    if (cargando) {
        return (
            <div className="text-center p-4 font-bold text-gray-600 text-sm">
                Cargando clases...
            </div>
        );
    }
    ...
    return (
        <div className="w-full max-w-full overflow-hidden px-2 py-1 sm:p-6 mx-auto box-border">
            ...
            <div className="block md:hidden w-full">
                ...
                {/* Scroll horizontal de días comprimido */}
                ...
                <div className="space-y-2 w-full">
                    {horarios.map((horario) => {
                        ...
                        return (
                            <div
                                key={clase.id}
                                onClick={() => navigate(`/reservar/${clase.id}`)}
                            ...
                            >
                                ...
                                <div className="text-right shrink-0 flex flex-col items-end justify-center">
                                    ...
                                    <span className="text-[10px] underline mt-1 font-medium">Reservar →</span>
                                </div>
                            </div>
                        );
                    })}
